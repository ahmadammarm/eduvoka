					...
					<div className="relative z-10">
						<div className="mt-8 text-center">
							...
							<div className="flex items-center justify-center">
								<a href="/dashboard">
									<div className="group border-border bg-white/30 flex h-[64px] cursor-pointer items-center gap-2 rounded-full border p-[11px] mt-10">
										...
										<div className="border-border flex size-[26px] items-center justify-center rounded-full border transition-all ease-in-out group-hover:ml-2">
											<svg
												xmlns="http://www.w3.org/2000/svg"
												width="18"
												height="18"
												...
												strokeLinecap="round"
												strokeLinejoin="round"
												className="lucide lucide-arrow-right transition-all ease-in-out group-hover:rotate-180 text-white"
												aria-hidden="true"
											>
