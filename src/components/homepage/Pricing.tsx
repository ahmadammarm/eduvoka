						...
						<motion.div
							...
							className={`relative rounded-2xl p-8 backdrop-blur-sm border transition-all duration-300 ${
								plan.popular
									...
									: "border-black/10 hover:border-black/20 bg-white/5 dark:border-white/10 dark:hover:border-white/20"
							}`}
						>
							{plan.popular && (
							...
							<div className="flex flex-col h-full">
								...
								<motion.button
									...
									className={`w-full py-3 px-6 rounded-lg font-medium transition-all duration-200 ${
										plan.popular
											? "bg-linear-to-r from-[#e78a53] to-[#e78a53]/80 text-white shadow-lg shadow-[#e78a53]/25 hover:shadow-[#e78a53]/40"
											: "text-black bg-white/10 dark:text-white border border-black/20 dark:border-white/20 hover:bg-white/20"
									}`}
								>
									{plan.cta}
								</motion.button>
